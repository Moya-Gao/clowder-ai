...
| [Antigravity CLI](https://antigravity.google/cli) | Gemini / Google アカウント側選択 | plain text (`agy --print`) | CLI 管理 | Gemini のデフォルト |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) | Gemini | stream-json | Yes | 明示的 fallback |
...
> Google consumer Gemini CLI / Gemini Code Assist individual requests は 2026-06-18 に停止されるため、Gemini は Antigravity CLI をデフォルトにしています。enterprise/API-key fallback で legacy CLI が必要な場合のみ `GEMINI_ADAPTER=gemini-cli` を明示してください。
