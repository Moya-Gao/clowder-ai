...
方法论来源：IdeaHub 社区咨询实证（`docs/research/2026-04-09-ideahub-test-automation-knowledge-consultation.md`）。
...
**交付物**：`docs/research/domain-glossary.md`（使用骨架模板 1）
...
**交付物**：`docs/research/business-rules.md`（使用骨架模板 2）
...
**交付物**：`docs/research/action-mapping.md`（使用骨架模板 3）
...
**交付物**：`docs/research/pattern-{name}.md`（使用骨架模板 4）
...
3. 迁移建议：导出为 .md → 加 frontmatter → 放入 `docs/research/`
...
- [ ] `docs/research/domain-glossary.md` — 业务概念词典（覆盖项目核心概念；中型项目通常 10-15 个，小项目 3-5 个即可）
- [ ] `docs/research/business-rules.md` — 业务规则表（覆盖主要实体间的约束关系）
- [ ] `docs/research/action-mapping.md` — 操作路径映射（覆盖用户高频操作路径）
- [ ] `docs/research/pattern-*.md` — 可复用模式（从已有代码/脚本中提取，数量视项目规模而定）
