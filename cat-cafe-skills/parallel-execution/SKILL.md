...
description: Use when facing 2+ independent tasks with no shared state — dispatch agents in parallel, execute sequentially with review checkpoints, or run plan batches
