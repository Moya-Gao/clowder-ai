...
| 触发 | 场景 | 主导 | 详细文档 |
|------|------|------|---------|
| 铲屎官说"做个 PPT" | **A: 内容规划** | 宪宪 | 主 skill 最小规则（ref 待补） |
...
| 审查通过 | **E: Export Truth Gate** | 砚砚 | 主 skill 最小规则（ref 待补） |
| 导出验证通过 | **F: 交付** | 宪宪 | [ppt-delivery.md](../refs/ppt-delivery.md) |
| 需要对比竞品 | **G: Benchmark 对拍** | 砚砚 + 烁烁 | 主 skill 最小规则（ref 待补） |
...
3. 调 auto-open API — 每个端口调一次
   curl -X POST http://localhost:3001/api/preview/auto-open \
