...
| 铲屎官说了 Magic Word / 直说"记一下/以后这样" / 同类被纠正 ≥2 次 / 做对了被明确表扬 / 铲屎官分享个人近况 | `cat_cafe_propose_profile_update` | 提议更新 per-cat 关系画像 primer（F231 Phase C），CVO 在 Hub 卡片审批；工具在 deferred list 需先 `tool_search` 加载（已进 L0 §8 Tier 1） |
