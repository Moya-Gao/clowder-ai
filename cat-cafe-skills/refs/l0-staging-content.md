...
items:
  ...
  - id: execution-context-signal
    ...
    family: shared
    source: runtime-sync 48 投递 (docs/discussions/2026-06-13-execution-context-signal-memo.md) + QA审查猫 re-review 判独立 +harness/新 F 号；铲屎官 CVO 终裁为 ADR-038 staging 增量、不开 F 号、直接做（推翻 QA审查猫建议）
    added_at: 2026-06-13
