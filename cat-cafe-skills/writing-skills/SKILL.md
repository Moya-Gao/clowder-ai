...
- 详见 `docs/research/knowledge-enginnering/knowledge-engineering-skills-mcp.md` §1.4（进场门票机制）
...
| 知识工程完整方法论 | `docs/research/knowledge-enginnering/knowledge-engineering-skills-mcp.md` | 触发设计、正反灰例、8 个可复用模式 |
