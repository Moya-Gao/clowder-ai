...
| F193 | Cross-Thread Communication Unification — F043/F052/F178 契约 reconcile + 接收侧 reply hint + split-only 配置 | spec | 布偶猫(Opus 4.7) | internal | [F193](features/F193-cross-thread-comm-unification.md) |
| F194 | Invocation Liveness Canonical Read Model — 后端 invocation 活性真相源收口（F183 post-close follow-up） | spec | 布偶猫(Opus 4.7) | internal | [F194](features/F194-invocation-liveness-canonical-read-model.md) |
