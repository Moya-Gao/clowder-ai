...
| F066 | Voice Pipeline Upgrade — 本地 TTS + 流式合成 + 播放队列 | phase1-done | 布偶猫 | [F066](features/F066-voice-pipeline-upgrade.md) |
...
| F085 | Hyperfocus Brake — 猫猫健康小刹车 | phase1-done | 布偶猫 | [F085](features/F085-hyperfocus-brake.md) |
