...
> 维护者：布偶猫 | 最后更新：2026-02-15 (F30/F28/F26 快速收割 — 等 review)
>
...
| F30 | **消息代码块复制按钮 + 文件路径可跳转** | **[~]** | 2026-02-14 铲屎官提议 | `9ffd972` — CodeBlock 复制按钮 (hover 显示) + linkifyFilePaths 检测绝对/相对路径渲染为 vscode://file/ 链接。等缅因猫 review。 |
...
| F28 | **授权请求跨渠道通知** | **[~]** | 2026-02-14 铲屎官提议 | `b98230f` — Desktop Notification API (requireInteraction) + Tab 标题闪烁 + Header amber badge + AuthorizationCard 脉冲动画。等缅因猫 review。计划: [`2026-02-14-f28-authorization-cross-channel-notification.md`](./plans/2026-02-14-f28-authorization-cross-channel-notification.md) |
...
| F26 | **UI Dashboard Upgrade — 右面板重构 + 实时计划进度** | **[~]** | 2026-02-14 铲屎官提议 | `f59740f` — 后端: invoke-single-cat 检测 TodoWrite/write_todos → yield task_progress。前端: RightStatusPanel 分区重构 (active/history) + CatTaskProgress checklist + 进度条 + CatInvocationCard 复用。5 tests。等缅因猫 review。计划: [`2026-02-14-ui-dashboard-upgrade.md`](./plans/2026-02-14-ui-dashboard-upgrade.md) |
