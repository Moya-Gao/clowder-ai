...
| F079 | Voting System — /vote 投票 + 弹窗配置 + 自动计票 + rich block 展示 | rework | 布偶猫 | [F079](features/F079-voting-system.md) |
...
| F082 | Git Health Panel — Repo 状态可视化（Git Log + Health Dashboard） | wip-p1 | 布偶猫 | [F082](features/F082-git-health-panel.md) |
