...
| F059 | Cat Café 开源计划 — 3/30 目标 | spec | 布偶猫 | internal | [F059](features/F059-open-source-plan.md) |
...
| F153 | Observability Infrastructure — 运行时可观测基础设施 | spec | Community + 布偶猫 | community [#388](https://github.com/zts212653/clowder-ai/issues/388) | [F153](features/F153-observability-infra.md) |
...
| F156 | WebSocket Security Hardening — 实时通道安全加固 | spec | 布偶猫 | internal | [F156](features/F156-websocket-security-hardening.md) |
| F157 | Feishu Receipt Ack — 猫猫即时接住替代"思考中→撤回" | spec | 布偶猫 | internal | [F157](features/F157-feishu-receipt-ack.md) |
