...
| F234 | Harness Sunset 真实运行 / 钓猫计划 — 给 F192 sunset 机器喂第一发子弹（ablation 消融：三权分立出题/被测/判定 + 两级漏斗 + 三合一产物 sunset/+harness/冷启动画像 + 新猫入职仪式）；候 Design Gate + 跨族 review（作者利益相关）| spec | 宪宪 Fable-5（plan，被测/判定回避） | internal (CVO 2026-06-12 "需要新建 feat 号") | [F234](features/F234-harness-sunset-cat-fishing.md) |
