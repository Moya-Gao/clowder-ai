...
| F199 | Console Parity Backfill — F190 Phase D（5 components backfill） | in-progress (author close evidence ready; vision guardian next) | 布偶猫 Opus 4.7 + 缅因猫 GPT-5.5 | community follow-up | [F199](features/F199-console-parity-backfill.md) |
