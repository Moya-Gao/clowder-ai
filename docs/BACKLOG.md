...
| F240 | IM Connector Plugin Architecture — 社区 PR #903 intake（IMConnectorPlugin 统一接口 + YAML manifest + 配置 Hub UI + action 状态机 + 外部 tar.gz 插件安装；CVO 2026-06-17 signoff 锚点纠正 F230/F231→F240；blocking: ① 外部插件 RCE 信任边界委托对方 CVO 权衡 ② 夹带 5 个 OpenCode P1 回归待剥离 ③ 架构建议归 F202 统一；#925 weixin 去重可独立先合，需 re-path） | awaiting-author-fix | community @mindfn + maintainers | community [#903](https://github.com/zts212653/clowder-ai/pull/903) + [#907](https://github.com/zts212653/clowder-ai/issues/907) | [F240](features/F240-im-connector-plugin-architecture.md) |
