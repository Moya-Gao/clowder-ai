...
| F146 | MCP Marketplace Control Plane — 一键接入 + 多生态聚合 | in-progress | 缅因猫 + 布偶猫 | internal | [F146](features/F146-mcp-marketplace-control-plane.md) |
...
| F168 | Community Operations Board — 社区事务编排引擎 | spec | 布偶猫 | internal | [F168](features/F168-community-ops-board.md) |
