...
| F048 | Restart Recovery — 重启自愈（Phase B: 队列持久化） | idea | 布偶猫 | [F048](features/F048-restart-recovery.md) |
...
| F058 | Mission Control 增强（F049++） | in-progress | 布偶猫 | [F058](features/F058-mission-control-enhancements.md) |
...
| F078 | Smart Routing & Group Mentions — 默认最近回复者 + @all/@thread 群组 mention | done | 布偶猫 | [F078](features/F078-smart-routing-group-mentions.md) |
| F079 | Voting System — /vote 投票 + 系统汇总 + rich block 展示 | spec | 布偶猫 | [F079](features/F079-voting-system.md) |
| F080 | Input History Completion — P1 done, P2 路径补全 in progress | active | 布偶猫 | [F080](features/F080-input-history-completion.md) |
