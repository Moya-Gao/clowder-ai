...
> 维护者：三猫 | 最后更新：2026-06-18（F242 close retracted truth sync）
>
...
| F203 | Native System Prompt L0 — Codex/Claude/OpenCode native 注入；AGY/IDE native 不可达已转 fallback | runtime-validation | 布偶猫 Opus 4.7 | internal | [F203](features/F203-native-system-prompt-l0.md) |
...
| F240 | IM Connector Plugin Architecture — 社区 PR #903 intake（IMConnectorPlugin 统一接口 + YAML manifest + 配置 Hub UI + action 状态机 + 外部 tar.gz 插件安装；4 轮 maintainer review 全过 → squash merged clowder-ai `40d38c18e628`；**intake-in-progress** Intent Issue cat-cafe#2412：子系统移位 + ConnectorRouter/gateway overlap 须 manual-port 保 6-12 演化 + F240 doc 保本 intake 版） | intake-in-progress | community @mindfn + maintainers | community [#903](https://github.com/zts212653/clowder-ai/pull/903) + [#907](https://github.com/zts212653/clowder-ai/issues/907) | [F240](features/F240-im-connector-plugin-architecture.md) |
