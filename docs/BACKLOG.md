...
| F199 | Console Parity Backfill — F190 Phase D（5 components backfill） | in-progress (D-1/D-2/D-3a/D-3b/D-4/D-5 merged; close gate next) | 布偶猫 Opus 4.7 + 缅因猫 GPT-5.5 | community follow-up | [F199](features/F199-console-parity-backfill.md) |
| F200 | Memory Recall Eval — 基于猫真实行为的记忆系统反馈闭环 | spec | 布偶猫 | internal | [F200](features/F200-memory-recall-eval.md) |
