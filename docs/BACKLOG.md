...
| F194 | Invocation Liveness Canonical Read Model — 后端 invocation 活性真相源收口（F183 post-close follow-up） | done | 布偶猫(Opus 4.7) | internal | [F194](features/F194-invocation-liveness-canonical-read-model.md) |
