...
| F222 | Frustration Auto-Issue — 把负体验变成结构化反馈（摩擦检测→采集日志→一键提单）| in-progress | 布偶猫 | internal | [F222](features/F222-frustration-auto-issue.md) |
| F223 | Capability Surface Registry — 把隐藏能力产品化成可发现、可执行、可验证的能力面 | in-progress | 缅因猫/砚砚 | internal | [F223](features/F223-capability-surface-registry.md) |
