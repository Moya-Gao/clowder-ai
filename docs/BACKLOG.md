...
| F101 | Mode v2 — 游戏系统引擎 + 狼人杀 | in-progress | 布偶猫 | [F101](features/F101-mode-v2-game-engine.md) |
...
| F105 | opencode 接入 — 金渐层（开源多模型编码猫 + OMOC） | phase-1-done | 布偶猫 | [F105](features/F105-opencode-golden-chinchilla.md) |
