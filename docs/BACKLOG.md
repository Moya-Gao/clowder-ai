...
| F238 | Bidirectional Boundary Symmetry — 双仓边界对称性强化（brand-dictionary single source of truth + reverse sanitizer detect-only + outbound 9 leak 修 + inbound 6 gap 补 + skill 12/13/22 词典化；F237 intake 硬前置） | spec-pending | 待 @fable5（Phase A spec） + @codex 砚砚（dictionary + skill） | internal (CVO 2026-06-16 self-decided via opus-47 maintainer judgment) | [F238](features/F238-bidirectional-boundary-symmetry.md) (pending) |
