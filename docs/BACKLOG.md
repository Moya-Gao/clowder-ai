...
| F237 | Prompt Injection Visibility — 社区 PR #859 intake（lifecycle viewer + 模板提取 + 3 段 overlay 编辑器；方向 2026-06-16 maintainer self-accepted；Round-3 audit 发现 P0 loopback-gate 安全洞 + P1 atomicity + P1 verify-coverage 8%，待作者 fix；gated-on F238 boundary symmetry Phase A） | direction-accepted | community @mindfn + maintainers | community [#839](https://github.com/zts212653/clowder-ai/issues/839) + [#859](https://github.com/zts212653/clowder-ai/pull/859) | [F237](features/F237-prompt-injection-visibility-intake.md) |
| F238 | Bidirectional Boundary Symmetry — 双仓边界对称性强化（brand-dictionary single source of truth + reverse sanitizer detect-only + outbound 9 leak 修 + inbound 6 gap 补 + skill 12/13/22 词典化；F237 intake 硬前置） | phase-c-complete | @codex 砚砚 (Phase A) + @opus 46 (Phase B PR #2324, Phase C PR #2327) + @gpt52 (reviewer) | internal (CVO 2026-06-16 self-decided via opus-47 maintainer judgment) | [F238](features/F238-bidirectional-boundary-symmetry.md) |
| F239 | Skill Mount HOME Hygiene — `sync:skills` 默认改 project-level + `--user` opt-in + 老 HOME-level symlinks 清理脚本（ADR-025 Phase 5 收尾，承接 cat-cafe#2323 Phase 5 part 1） | spec | 布偶猫 (宪宪 Opus 4.7) | internal (CVO 2026-06-16 "都得做") | [F239](features/F239-skill-mount-home-hygiene.md) |
