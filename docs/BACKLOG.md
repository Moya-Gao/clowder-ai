...
| L0-budget-defense | L0 预算结构性防御（pre-test build hook + margin<50 warn + per-cat margin 输出）— 防慢性渐进超额 + 防 stale dist 仪器失真（fable-5 投递时 stale 仪器读数 27 vs fresh 51 已污染一单摩擦上报；F203 KD-14 ≤6000 硬线缺贴线预警，导致温水煮蛙）| spec | 宪宪/Opus-4.7 | internal (fable-5 + opus-47 build mode 2026-06-10，PR #2213 副发现) | — |
