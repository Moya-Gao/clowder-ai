...
| F225 | Cat-Initiated Session Handoff — 猫主导的 session 接力（猫主动提议封印 + 铲屎官 gate + 同 thread 续接注入交接留言）| spec | 宪宪 Opus-4.8 | internal | [F225](features/F225-cat-initiated-session-handoff.md) |
