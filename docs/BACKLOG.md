...
| F059 | Cat Café 开源计划 — 3/30 目标 | in-progress | 布偶猫 | internal | [F059](features/F059-open-source-plan.md) |
...
| F088 | Multi-Platform Chat Gateway — 飞书/Telegram 多平台网关 | phase5-6-done | 布偶猫 | internal | [F088](features/F088-multi-platform-chat-gateway.md) |
...
| F111 | Streaming TTS Chunker — 流式分句合成管线 | spec | 金渐层 | internal | [F111](features/F111-streaming-tts-chunker.md) |
| F112 | Voice Playback Queue — 语音播放队列 + Intent 调度 | spec | 金渐层 | internal | [F112](features/F112-voice-playback-queue.md) |
