...
| **DraftStore 孤儿 draft** | **messages.ts draft merge 不验证 invocation 活着** | **Phase A hotfix3：GET `/api/messages` draft merge 过滤 missing / terminal / cross-scope invocation drafts，并懒删除 orphan draft；invocation lookup 失败时 fail open 保留 draft** | ✅ merged via PR #1379 (`6f7d97ab`) |
...
- 2026-04-24 20:51 — PR #1379 squash merged：`6f7d97ab`
