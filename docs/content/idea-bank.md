...
- **我的立场**：我们家 clowder-ai ~1100 stars 没刷过一颗，教程仓（cat-cafe-tutorials）经历过 597 星一夜归零，知道 stars 的脆弱。
- **可用数据**：两个匿名项目的对比（6k stars/30 contributors vs 1100 stars/17 contributors/120 active issues）
...
- **对照**：同时段平时发帖约 50 阅读
- **跨平台溢出**：B站同期 +2 粉丝
- **标题关键词**：没写"腾讯"，可能损失搜索命中

### 2026-05-18 小红书面经 #2：字节 1-3 面综合
- **内容**：字节 agent 开发社招 1-3 面综合面经（含实战场景题 + 架构题 + 手撕代码）
- **早期数据**：6 小时内 172❤️ / 340 收藏 / 3121 观看
- **截至 6/7 数据**：**14000 观看**（5 条面经中最高）
- **归档**：📦 `docs/discussions/career-planning/2026-05-18-bytedance-round1-3-combined-debrief.md`

### 小红书面经 #3：深信服
- **截至 6/7 数据**：**~10000 观看**（5 条中第二高）

### 小红书面经 #4：阿里国际
- **截至 6/7 数据**：**~1700 观看**（5 条中最低）

### 小红书面经 #5：待补充
- **数据**：待补充

### 2026-06-07 阶段性里程碑
- **小红书粉丝**：**1233 粉**（从 5/7 ~30 粉起步，31 天 ×40 倍）
- **GitHub stars**：clowder-ai **~1100 stars**
- **粉丝 vs stars 交叉点**：小红书粉丝数（1233）已超过 GitHub stars（~1100），20 天前 stars 还是粉丝的近 2 倍
- **面经帖总数**：5 条，观看范围 1700～14000

### 面经品类数据分析（5 条验证后更新）
- **可复制性：强验证**。5 条面经全部有效，不是某一家话题红利——字节最高（14000）、深信服第二（10000）、阿里国际最低（1700）
- **大厂 vs 非大厂效应**：字节（14000）> 深信服（10000）> 阿里国际（1700），大厂标签仍是搜索入口的核心驱动力
- **互动结构差异**：字节帖收藏 > 点赞（340 vs 172），wxg 帖点赞 > 收藏（125 vs 229 但差距小）。高收藏率 = 用户觉得"有用要存着看"，搜索属性强
- **增长曲线**：30 粉 → 351 粉（11 天，日均 29）→ 1233 粉（又 20 天，日均 44），增速持续加快
- **关键信号**：面经品类在小红书是"搜索驱动 + 高收藏率"的组合，完美匹配 CES 权重（收藏×1 + 关注×8）
- **标题关键词实验**：wxg 帖没写"腾讯"，字节帖直接写"字节"——大众搜"字节面经"不搜"wxg面经"，标题关键词 = 搜索入口
- **跨平台溢出**：B站多次出现自然涨粉，无需主动投放
- **GitHub stars 滞后但在涨**：5/18 时面经未带动 stars；但 6/7 clowder-ai 已从 ~655 涨到 ~1100，可能有其他渠道（Linux-do / B站溢出 / 自然搜索）在贡献
- **启示**：面经是已验证的起号利器。下一步验证：① 面经能否带"第二跳"（猫猫点评→系统实战）② 标题加公司全称对搜索命中率的影响 ③ 非大厂面经的流量地板在哪
...
| 597 星事故（教程仓） | `docs/stories/597-stars-incident/` | 完整 | 翻车/脆弱 |
