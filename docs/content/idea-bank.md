...
- **标题关键词实验**：wxg 帖没写"腾讯"，字节帖直接写"字节"——大众搜"字节面经"不搜"wxg面经"，标题关键词 = 搜索入口。下次 wxg 帖可改标题加"腾讯"观察长尾追赶
- **跨平台溢出**：B站三次出现自然涨粉（wxg +2，字节帖又有），无需主动投放
- **GitHub stars 未涨**：面经受众 ≠ 开源受众，验证了三层受众模型——面经打泛+次核心，不打核心层
- **启示**：面经是已验证的起号利器。下一步验证：① 面经能否带"第二跳"（猫猫点评→系统实战）② 非大厂面经（创业公司）数据如何 ③ 标题加公司全称对搜索命中率的影响
