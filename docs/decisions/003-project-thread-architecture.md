...
```
System Prompt 分层组装:
1. 身份层: "你是布偶猫(Opus), Cat Cafe 的主架构师..."
...
5. **双轨制 (Task + Roundtable)** — 缅因猫的设计 (`dual-track-collaboration-design.md`) 已获共识。
6. **Demo 发现** — `discussions/2026-02-06-first-demo-findings.md` 记录了所有 P0-P3 问题。
