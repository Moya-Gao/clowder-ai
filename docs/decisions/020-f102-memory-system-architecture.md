...
> **Status**: accepted
> **Deciders**: 铲屎官 + 布偶猫(opus) + 缅因猫(gpt52) + 金渐层(opencode)
> **Date**: 2026-03-22
...
- [Lossless Claw 调研](../research/2026-03-19-lossless-claw-session-chain-comparison.md)
- [OpenClaw 深度研究](../research/2026-03-16-openclaw-cat-cafe-learning-synthesis.md)
- [Anthropic Skills 最佳实践](../research/2026-03-22-anthropic-skills-best-practices.md)
- [LL-034: Embedding 实现教训](../lessons-learned.md#LL-034)
