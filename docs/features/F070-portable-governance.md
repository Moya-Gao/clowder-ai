...
| Gap | Issue | Fix | PR |
|-----|-------|-----|-----|
| governance-pack.ts leaks internal ports (3001/6399) to open-source | clowder-ai#97 | Source keeps internal defaults; sync-to-opensource.sh transforms both frontend port line and Redis port line to public defaults (3004/6379/6380). Version bumped to 1.3.0. | #532 |
