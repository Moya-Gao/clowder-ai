...
| 2026-05-07 | Bugfix: StreamingOutboundHook race — buffer early chunks until placeholder ready + tombstone late-start cleanup; prevents Telegram duplicate message + probabilistic streaming under slow sendPlaceholder (PR #1594) |
