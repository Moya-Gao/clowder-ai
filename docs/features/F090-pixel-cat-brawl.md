...
**Debuff 技能 [Code Review]**（砚砚共有）：标记对手弱点，下 3s 对手伤害 -40% 且受到的伤害 +25%。
...
**烁烁调研推荐（2026-03-09）**：
- **CUTE LEGENDS: CAT HEROES (by 9E0)** — ✅ **铲屎官选定**，16x16 极简但表现力强，4 种职业猫咪英雄
- ~~2D Cat Street Fighter (by TampG)~~ — 淘汰（铲屎官：太丑了）
...
**视觉设计详细方案**：[F090 视觉提案](/docs/design/F090-pixel-cat-brawl-visuals.md)（烁烁 @gemini）
...
- 视觉设计：[F090 视觉提案](/docs/design/F090-pixel-cat-brawl-visuals.md)（烁烁）
- 讨论来源：Thread（2026-03-09 06:57~07:23）
...
| KD-6 | 素材选定 CUTE LEGENDS: CAT HEROES (by 9E0)，16x16 像素风 | 2026-03-09 | 铲屎官 |
...
### Threat Model v1（砚砚 @codex，2026-03-09）
