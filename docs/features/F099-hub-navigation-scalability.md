...
V1 (PR #384) 先实现 Bento Box 网格，铲屎官反馈后 V2 (PR #396) 改为手风琴式：
- 所有组始终可见（collapsed/expanded），单击展开直达子项
- Emoji 图标 → Lucide 风格 inline SVG（对照 Pencil 设计稿 1:1 实现）
- 品种色：opus 紫 (#9B7EBD)、铲屎官拿铁 (#E29578)、codex 蓝 (#5B9BD5)
...
铲屎官反馈治理看板"像配置类，该放 Hub 里"，Phase B 不急。
...
- [x] AC-A5: 铲屎官确认视觉方案（SVG 图标 + 品种色，Design Gate）
...
| KD-9 | Bento Box → 手风琴抽屉式 | 铲屎官反馈 Bento 两步导航不直觉 + emoji 丑；改为 accordion + SVG 图标 | 2026-03-12 |
| KD-10 | Hub 齿轮入口加到顶栏 | 铲屎官反馈：工作区模式下右面板齿轮不可见，顶栏需常驻入口 | 2026-03-12 |
...
| 2026-03-12 | 愿景守护（GPT-5.4）放行 + feat close |
