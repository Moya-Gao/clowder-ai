...
**A2. 选词系统（WordBank + 铲屎官自选）**

两种模式：
- **铲屎官选词**：铲屎官开局为每只猫手动指定脑门词（传统模式，支持恶趣味操作）
- **自动选词**：从词库随机抽取同主题词组（AI 关键词 / 历史人物 / 科技名人 等）
...
| R3 | "一定要告诉猫猫们坏猫战术！！！" | AC-A4 | test + manual | [ ] |
...
| # | 问题 | 状态 |
|---|------|------|
| OQ-1 | 猜错是否有惩罚（跳过一轮 / 纯无惩罚）？ | ⬜ 待确认 |
| OQ-2 | 是否允许猫猫之间互相讨论/质疑回答？ | ⬜ 待确认 |
| OQ-3 | 自动选词词库第一版包含哪些主题？ | ⬜ 待确认 |
...
| KD-2 | AI prompt 必须注入坏猫战术 | 铲屎官强调"一定要告诉猫猫们坏猫战术"，这是游戏灵魂 | 2026-03-12 |
| KD-3 | 支持铲屎官手动选词 + 自动词库双模式 | 手动 = 恶趣味传统，自动 = 方便快速开局 | 2026-03-12 |
| KD-4 | 猜错不淘汰，继续下一轮 | 猫猫杀传统规则，淘汰制不适合（只有猜词这一个目标） | 2026-03-12 |
