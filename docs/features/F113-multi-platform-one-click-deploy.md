...
- [x] AC-B6: ~~铲屎官在 macOS 真机上完成端到端验收~~ 社区多位小伙伴实际使用验证（铲屎官 2026-05-26 确认通过）
...
| 2026-03-31 | Phase E: absorbed project setup card from `clowder-ai#299` (cat-cafe PR #888) |
| 2026-04-11 | Phase B: intake doc refresh from `clowder-ai#380` — Phase 重排 + Phase B 详情 + Key Decisions/Risk |
