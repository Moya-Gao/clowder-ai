...
| 2026-03-16 | fix: room routing + hardcoded port + skill contract (PR #483)。fail-closed room scope + API port 从 frontend port 推导 + browser-preview skill worktreeId 必传。砚砚(gpt52) review 放行 + 云端 review P1 修复 |
