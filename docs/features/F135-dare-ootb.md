...
> **Status**: done (closed — 需求已不存在，铲屎官 2026-05-26 拍板) | **Owner**: bouillipx (社区) | **Priority**: P2
>
...
| # | 问题 | 状态 |
|---|------|------|
| OQ-1 | DARE repo 来源（直接 clone org repo） | ✅ 铲屎官决定 |
| OQ-2 | Windows 适配 | ⏸️ macOS 先做，Windows 留接口 |
| OQ-3 | bootstrap binding mode（oauth vs api_key） | ⬜ PR #194 中 dare 设为 oauth mode 但实际用 API key，需修正 |

## Timeline

| 日期 | 事件 |
|------|------|
| 2026-03-23 | 社区 PR #192/#194 提交，使用了错误的 F132 编号 |
| 2026-03-23 | Maintainer review：分配 F135，创建 issue #195 |

## Links

| 类型 | 路径 | 说明 |
|------|------|------|
| **Issue** | [clowder-ai#195](https://github.com/zts212653/clowder-ai/issues/195) | 开源仓 issue |
| **PR** | [clowder-ai#192](https://github.com/zts212653/clowder-ai/pull/192) | docs kickoff |
| **PR** | [clowder-ai#194](https://github.com/zts212653/clowder-ai/pull/194) | Phase A implementation |
| **Feature** | `docs/features/F050-a2a-external-agent-onboarding.md` | 父 feature |
