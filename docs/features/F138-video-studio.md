...
**[garden-skills/web-video-presentation](https://github.com/ConardLi/garden-skills)**（@e3e9ada8）— 知识讲解视频 skill 集：
- 技术栈：Vite + React + TS 16:9 舞台 + TTS（MiniMax/OpenAI）+ 浏览器录屏
- 可学习的：`narrations.ts` 单一真相源（数组长度 = step 数 = TTS 输入 = 播放推进）、scaffold 一键起项目体验、25 套具名 style-recipes、CHAPTER-CRAFT 视觉演示约束
...
| KD-15 | garden-skills 吸收策略：学起手体验（scaffold）和约束思想（beat_ledger），不降级核心架构（全局音频/FA/真渲染不动）。具体：P0 scaffold → P1 beat_ledger invariant → P2 style-recipes → P3 knowledge-explainer 模板。不吸收：逐 step TTS / 浏览器录屏产物 / kb-retriever | 宪宪 + 砚砚讨论收敛 + 铲屎官拍板 | 2026-06-01 |
...
- [waoowaoo 深度调研报告](../research/f138-video-studio/2026-03-25-waoowaoo-deep-dive.md)
- [GPT Pro 设计审阅](../research/f138-video-studio/2026-03-24-f138-gpt-pro-consult.md)
- [GPT Pro 开源生态扫描（2026-04-05）](../research/f138-video-studio/2026-04-05-f138-video-pipeline-gpt-pro-consult.md)
- [Gemini 技术路线还原（2026-04-05）](../research/f138-video-studio/2026-04-05-f138-video-pipeline-gemini-consult.md)
...
- [garden-skills（ConardLi）](https://github.com/ConardLi/garden-skills)（参考 skill 集，KD-15 吸收策略）
