...
> **Status**: done (Phase A accepted / frozen; F155 closed 2026-05-26) | **Owner**: 布偶猫/宪宪 | **Priority**: P1
...
- Phase A: 缅因猫/gpt52 负责安全边界 + 可测性 review
- Phase B: 缅因猫/gpt52 安全 review + 暹罗猫/gemini25 视觉 review
...
| 类型 | 路径 | 说明 |
|------|------|------|
| **Discussion** | `docs/discussions/2026-03-27-F155-guidance-engine-convergence.md` | 三猫讨论收敛纪要 |
| **Scene Catalog** | `docs/features/F155-scene-catalog.md` | 全量引导场景清单（含当前 in-scope 与 deferred 场景） |
| **Skill** | `cat-cafe-skills/guide-authoring/SKILL.md` | 引导流程设计 SOP |
| **Feature** | `docs/features/F087-bootcamp.md` | 类似引导概念（训练营） |
| **Feature** | `docs/features/F134-feishu-group-chat.md` | 飞书对接业务背景 |
| **Feature** | `docs/features/F137-weixin-personal-gateway.md` | 微信对接业务背景 |
