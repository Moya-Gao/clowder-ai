...
| 类型 | 路径 | 说明 |
|------|------|------|
| **Feature** | `docs/features/F087-cvo-bootcamp.md` | 原 open-source onboarding 主语，F171 从这里演化 |
| **Feature** | `docs/features/F110-bootcamp-vision-elicitation.md` | 训练营中后段访谈与 SOP 引导增强 |
