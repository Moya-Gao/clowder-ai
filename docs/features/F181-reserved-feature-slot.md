...
- [x] AC-A1: F181 有稳定 `docs/features/` 聚合文件和 `docs/BACKLOG.md` 活跃入口。
...
| # | 问题 | 状态 |
|---|------|------|
| OQ-1 | "他"具体指谁或哪项需求？ | ⬜ 待铲屎官补上下文 |
| OQ-2 | F181 的 owner / priority 是什么？ | ⬜ 待确认 |
| OQ-3 | F181 是否关联现有 feature、社区 issue 或 PR？ | ⬜ 待关联检测 |

## Key Decisions

| # | 决策 | 理由 | 日期 |
|---|------|------|------|
| KD-1 | 先占号，不推断需求范围 | 铲屎官只要求"为他保留"，当前证据不足，编造 scope 会污染真相源 | 2026-04-30 |

## Timeline

| 日期 | 事件 |
|------|------|
| 2026-04-30 | F181 立项占号，等待补充具体 scope |

## Links

| 类型 | 路径 | 说明 |
|------|------|------|
| **Backlog** | `docs/BACKLOG.md` | 活跃 feature 入口 |
