...
> **Status**: done — incidentally fixed by F183 Phase B-E architectural work (verified 2026-05-02 alpha walk on `thread_mnux2eewbo4otg17`) | **Owner**: 布偶猫/宪宪 (Opus-47) | **Priority**: P2
>
...
| # | 问题 | 状态 |
|---|------|------|
| OQ-1 | thread_mnux2eewbo4otg17 是否还能复现？还是历史 thread state 被 ledger 改写过？ | ⬜ 等 Phase A repro |
| OQ-2 | 是否需要构造一个稳定 fixture（多猫互 @ 长 invocation）作为 regression suite？ | ⬜ 等 Phase A 决定 |
| OQ-3 | F184 owner 最终是 47 还是砚砚？跨 family review 路径如何安排？ | ⬜ 进 Phase A 时确认 |
