...
| # | 问题 | 状态 |
|---|------|------|
| OQ-1 | CLI carrier（本地 invoke-single-cat）是否也走 OperationContext builder？ | ⬜ 未定 |
| OQ-2 | 是否和 F161 ACP Carrier Generalization 合并实施？ | ⬜ 未定 |
...
| 日期 | 事件 |
|------|------|
| 2026-05-06 | GBrain teardown 复盘 → 单点化需求识别 → 立项 |

## Links

| 类型 | 路径 | 说明 |
|------|------|------|
| **Discussion** | `docs/discussions/2026-05-03-gbrain-deep-dive/` | GBrain 拆解：Operation Context 是 P1 upstream risk |
| **Feature** | `docs/features/F161-acp-carrier-generalization.md` | 载体抽象层 |
