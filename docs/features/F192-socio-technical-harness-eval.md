...
- task-outcome verdict generator 仍待建；PR #2161 (2026-06-09, squash `d221715148`) 已先落 schema/type/instruction contract surface + `docs/harness-feedback/SPEC.md`，并保持 honest `unsupported_generator` 501，后续 PR2 再原子 wire generator
