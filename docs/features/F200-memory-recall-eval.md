...
5. **spec 调研完成**：HW-1 coverage search research doc done（`6cb3d7d22`）→ 待 Design Gate 讨论 + 砚砚 review 原始 5 步 pipeline 扩展方向
