...
> **Status**: done ✅ **post-close regression FIXED + merged (PR #1940 → `a0f7cf208`, opus-4.8): REG1 visibility + REG2 re-summon continuity + REG3 Layer B image urls; REG3 Layer C platform-bound → F061 carrier** | **Owner**: 缅因猫（砚砚）; regression fixes 布偶猫 Opus 4.8 | **Priority**: P1 | **Completed**: 2026-05-26
