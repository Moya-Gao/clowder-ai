...
> **Status**: done | **Owner**: 宪宪/Opus-4.8（布偶猫） | **Priority**: P2
...
| R2 | "不准动 redis相关的那些！！"（铲屎官 2026-05-28） | AC-A2/A3, Fixture 4 | test（硬拒绝 .rdb/.sqlite） | [x] |
| R3 | 有状态存储迁移"甚至不应该列"为后续 Phase（铲屎官 2026-05-28） | Scope 边界节 | manual（spec 审查无尾巴） | [x] |
