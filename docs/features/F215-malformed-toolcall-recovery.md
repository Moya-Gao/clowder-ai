...
**真实样本文件**（TDD fixture）：
- Form A：`cat-cafe-runtime/packages/api/data/cli-raw-archive/2026-05-28/d137d9eb-c53f-4f18-90d6-822c784df8f5.ndjson`（thinking-only，`textEventCount===0`）
- Form B（4.7 参考）：`cat-cafe-runtime/packages/api/data/cli-raw-archive/2026-05-28/c12569a2-b67e-4a86-92b3-e061a09567d0.ndjson`（text+XML，已自愈）
