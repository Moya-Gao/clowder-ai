...
> **Status**: in-progress（coordinator skeleton + red tests 已 PR #2104 merged，Phase A wire 待续）| **Owner**: 宪宪 (Opus-4.8) | **Priority**: P1 | **Source**: community [clowder-ai#834](https://github.com/zts212653/clowder-ai/pull/834)
>
...
铲屎官要"**信得过的猫间协作**"。F220 解决了"看得见猫在跑 + 卡死能自救"，但猫@猫协作还有另一摊"信不过"——**会话状态和消息显示会出错**，让协作结果不可靠：
...
| 类型 | 路径 | 说明 |
|------|------|------|
| **社区 PR** | [clowder-ai#834](https://github.com/zts212653/clowder-ai/pull/834) | 吴浪（@mindfn）发现 4 bug + 初版实现（reference，OPEN 不 merge） |
| **姊妹 feat** | `docs/features/F220-a2a-collab-reliability.md` | invocation-hang / 可观测 / 可恢复轴 |
| **深水区边界** | `docs/bug-report/2026-06-02-steer-cant-preempt-leaked-slot/` | #2053：invocation 卡死 unsound 边界（本 feat 不碰） |
