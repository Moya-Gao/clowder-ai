...
| F237 | F237: Prompt Injection Visibility — 社区 PR #859 intake（52 段 lifecycle viewer + 模板提取 + 3 段 overlay editor；clowder-ai#859 `4241932f` → cat-cafe#2505 `b859eb38`；F238 Brand Guard + ledger close） | done | [F237-prompt-injection-visibility.md](./F237-prompt-injection-visibility.md) |
