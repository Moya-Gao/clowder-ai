...
| F174 | F174: Callback Auth Lifecycle & Resilience — 鉴权基础设施持久化、降级、telemetry + D2b 三层明厨亮灶（HubButton badge merge）| done | [F174-callback-auth-lifecycle.md](./F174-callback-auth-lifecycle.md) |
