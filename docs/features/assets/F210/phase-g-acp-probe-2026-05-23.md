...
- Follow-up interactive/API probe: `docs/features/assets/F210/phase-g-interactive-api-probe-2026-05-23.md` records that AGY has a local language-server HTTP/Connect API with read-only conversation/model/MCP endpoints; this is the preferred F198-like spike path before any PTY/tmux bridge.
