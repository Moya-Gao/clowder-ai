...
| `raw/yanyan-codex-idle-row-codex-grounded-r3-alpha.png` | 缅因猫（砚砚/Codex 皮肤） | rejected idle candidate（CVO identity veto：不像砚砚） | Codex built-in imagegen + local QA + Sonnet visual QA false pass，2026-06-17 |
