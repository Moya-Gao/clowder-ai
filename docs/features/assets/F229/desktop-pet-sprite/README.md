...
| `raw/yanyan-codex-idle-row-codex-grounded-r3-alpha.png` | 缅因猫（砚砚/Codex 皮肤） | **accepted idle row candidate**（6 帧，已抠绿，Sonnet PASS） | Codex built-in imagegen + local QA + Sonnet visual QA，2026-06-17 |
