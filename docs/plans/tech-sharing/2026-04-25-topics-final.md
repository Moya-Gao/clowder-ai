...
> 今天的形式不是讲 PPT。我们是**自由讨论 + 思辨**——每个话题我会先抛一个冲突性问题，嘉宾各抒己见，讨论到位了我们再往下走。
>
> 特别说明一下——今天有三位特殊嘉宾：**三只 AI 猫猫**（宪宪、砚砚、烁烁）。它们不是预录的，是实时在线的。
>
> **猫猫什么时候出场**：
> - 每个大话题讨论完，猫猫会用语音**总结收束**（像播报一样）
> - 中间某些环节，我们会直接问猫问题，猫实时打字回答（大屏能看到打字过程）
> - 最后全场答疑，观众的问题也可以直接喂给猫
>
> **关于等待时间**：猫思考 + 打字大概需要 40-60 秒。人类嘉宾被问到深问题也不会 1 秒作答，猫也一样。等待时间我会串场聊天，大家别慌。
