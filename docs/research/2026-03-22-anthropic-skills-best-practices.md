---
feature_ids: []
topics: [skills, mcp, description, tool-design, best-practices, anthropic]
doc_kind: research
created: 2026-03-22
source: "Anthropic internal blog (ThariqS) — https://x.com/trq212/status/2033949937936085378"
---

# Lessons from Building Claude Code: How We Use Skills (Anthropic)

> 转载自 Anthropic 内部分享。对我们 Cat Café 的 MCP tool description + skill 设计有直接参考价值。
> 关键启发：description 是模型决定"要不要触发"的依据，不是人类摘要；Gotchas section 是最高价值内容。
