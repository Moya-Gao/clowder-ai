...
doc_kind: research-consult
created: 2026-06-10
source_thread: "A2A handoff to @codex, Cat Cafe anime short series production pipeline"
related_features: [F138]
---

# Cat Cafe Anime Short Series Pipeline - Cloud Research Mode B Consult

## Part 1: Prompt for cloud research model

> Copy everything in this section into the cloud model. The model should use live web/GitHub research.
...
> After Part 2 is filled, @codex should compare it with F138/video-forge and write the final local recommendation.
