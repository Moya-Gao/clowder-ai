...
export const ENV_VARS: EnvDefinition[] = [
  ...
  { name: 'MAX_A2A_DEPTH', defaultValue: '2', description: 'A2A 猫猫互调最大深度', category: 'budget', sensitive: false },
  ...
  { name: 'AUDIT_LOG_DIR', defaultValue: '~/.cat-cafe/audit', description: '审计日志目录', category: 'cli', sensitive: false },
  { name: 'CLI_RAW_ARCHIVE_DIR', defaultValue: '~/.cat-cafe/cli-archive', description: 'CLI 原始日志归档目录', category: 'cli', sensitive: false },
  ...
  // --- hindsight ---
  { name: 'HINDSIGHT_URL', defaultValue: 'http://localhost:8888', description: 'Hindsight 服务地址', category: 'hindsight', sensitive: false },
