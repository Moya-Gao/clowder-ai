...
export interface OpenCodeRuntimeConfigOptions {
  ...
  /** Absolute path to Cat Café MCP server entry (packages/mcp-server/dist/index.js). */
  mcpServerPath?: string;
  /** Workspace exposed to Cat Café MCP servers for this invocation. */
...
export function generateOpenCodeRuntimeConfig(options: OpenCodeRuntimeConfigOptions): OpenCodeConfig {
  ...
  // #935: Grant external_directory permission for Cat Cafe-approved workspace roots.
