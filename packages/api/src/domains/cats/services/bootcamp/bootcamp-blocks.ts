...
export const taskSelectionBlock: BootcampInteractiveBlock = {
  ...
  options: [
    ...
    { id: 'Q3', icon: 'search', label: '猫猫侦探社', description: '游戏化 debug ~1h', level: 1, group: 'Lv.1 好玩上手' },
    ...
    { id: 'Q7', icon: 'utensils', label: '猫猫点餐', description: '全栈点餐系统 ~2h', level: 1, group: 'Lv.1 好玩上手' },
    ...
    { id: 'Q10', icon: 'heart', label: '猫猫互动玩具', description: '逗猫棒+摸头 ~1h', level: 1, group: 'Lv.1 好玩上手' },
    // Lv.2 — 有深度
