/**
 * F208 Phase D: DossierObservationStore — CVO observation staging layer.
 *
 * AC-D1: CVO writes observations + provenance, stored in pending layer.
 * OQ-10: Phase D = staging + read display; promotion to summary layer in Phase E.
 * AC-D3: Observations do NOT auto-replace summary layer (peer/CVO judgment + provenance).
 *
