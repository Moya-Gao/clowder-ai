...
export function buildCatIdentityAliases(
  ...
  // coCreator identity (Landy / L.S. / Lysander etc.)
  if (coCreator) {
 ...
 */
/**
 * Well-known common English words that also serve as Cat Café identifiers.
 ...
 * without referring to a Cat Café identity. Proper nouns that are
 * distinctive enough to safely redact (e.g. "Gemini", "Landy",
