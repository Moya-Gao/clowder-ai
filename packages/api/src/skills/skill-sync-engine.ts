...
async function syncProjectUnlocked(
  ...
  // PUT /api/mount-rules). Path A simplification (CVO/mindfn 2026-06-17 IM sync):
  ...
  // POST /api/skills/sync (the over-preservation Path C trade-off Cat Cafe explicitly
