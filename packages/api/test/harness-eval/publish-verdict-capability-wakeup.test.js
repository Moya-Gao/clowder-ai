  ...
  it('happy path: handler dispatches to cw adapter, returns verdict path + commit/PR', async () => {
    ...
    const mockGitPublisher = {
      async publishOnIsolatedWorktree(opts) {
        ...
        return { commitSha: 'cw-sha-1234', prUrl: 'https://github.com/zts212653/cat-cafe/pull/9000' };
      },
    };
...
`,
    ...
    assert.equal(result.prUrl, 'https://github.com/zts212653/cat-cafe/pull/9000');
