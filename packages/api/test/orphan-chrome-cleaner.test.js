...
const NODE_BOTH_KEYWORDS =
  '    1 70293 /Users/lysander/.local/bin/claude -p Google Chrome Helper --user-data-dir=/tmp/agent-browser-chrome in prompt text';

// Node process: ppid=1, has marker but no Chrome keyword
const NODE_MARKER_ONLY =
  '    1 70294 /Users/lysander/.local/bin/claude -p ... agent-browser-chrome marker in prompt text ...';

// Normal user Chrome: ppid=1, Chrome binary, but NO agent-browser user-data-dir
const NORMAL_CHROME =
  '    1 63814 /Applications/Google Chrome.app/Contents/MacOS/Google Chrome --type=renderer --user-data-dir=/Users/lysander/Library/Application Support/Google/Chrome';
