  ...
  test('renders collection distribution footer when groups present (AC-H4)', async () => {
    ...
    globalThis.fetch = async () => ({
      ...
      json: async () => ({
        ...
        groups: [
          { key: 'project:cafe', type: 'collection', label: 'Cat Café Project', count: 6, available: 10 },
    ...
    assert.ok(text.includes('Cat Café Project(6/10)'), 'footer must show collection with count/available');
