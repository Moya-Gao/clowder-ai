    ...
    <div className="mt-2 p-2 rounded border border-dashed border-gray-300 bg-white">
      ...
      <div className="space-y-1.5">
        <select
          ...
          className="w-full text-[11px] px-2 py-1 rounded border border-gray-200 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-owner-primary"
        >
        ...
        <input
          ...
          maxLength={500}
          className="w-full text-[11px] font-mono px-2 py-1 rounded border border-gray-200 bg-gray-50 focus:outline-none focus:ring-1 focus:ring-owner-primary"
        />
        <button
          type="button"
