  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        disabled={loading}
        className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-[var(--console-rail-item)] hover:bg-[var(--console-hover-bg)] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        title="导出对话"
        aria-label="导出对话"
      >
        {loading ? (
