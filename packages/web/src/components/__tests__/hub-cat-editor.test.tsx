...
describe('HubCatEditor', () => {
  ...
  it('blocks creating opencode member with bare model (no provider/model format)', async () => {
    const onSaved = vi.fn(() => Promise.resolve());
    ...
    // Save should be blocked — opencode bare model rejected (requires providerId/modelId).
