...
export function buildCallHint(
  ...
  // Match display URL to actual SDK runtime behavior:
  // - base has /v1 + suffix has /v1 → strip /v1 from base to avoid /v1/v1
  // - base has /vN (N≠1) + suffix has /v1 → keep base, strip /v1 from suffix
  //   so /v2 + /v1/chat/completions → /v2/chat/completions (#886)
