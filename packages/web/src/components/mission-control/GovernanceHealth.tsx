  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-[var(--console-border-soft)] bg-[var(--console-card-bg)] p-3">
        <div className="mb-2 text-[10px] font-semibold uppercase text-cafe-secondary">Triage Distribution</div>
        {total === 0 ? (
      ...
      {/* Source distribution */}
      <div className="rounded-lg border border-[var(--console-border-soft)] bg-[var(--console-card-bg)] p-3">
        <div className="mb-2 text-[10px] font-semibold uppercase text-cafe-secondary">Source Tag Distribution</div>
      ...
      {topRisks.length > 0 && (
        <div className="rounded-lg border border-[var(--console-border-soft)] bg-[var(--console-card-bg)] p-3">
          <div className="mb-2 text-[10px] font-semibold uppercase text-cafe-secondary">Top Risk Signals</div>
      ...
      {digests.length > 0 && (
        <div className="rounded-lg border border-[var(--console-border-soft)] bg-[var(--console-card-bg)] p-3">
          <div className="mb-2 text-[10px] font-semibold uppercase text-cafe-secondary">Dispatch Stats</div>
          <div className="grid grid-cols-3 gap-3">
      ...
      {resolutions.length > 0 && (
        <div className="rounded-lg border border-[var(--console-border-soft)] bg-[var(--console-card-bg)] p-3">
          <div className="mb-2 text-[10px] font-semibold uppercase text-cafe-secondary">Resolution Progress</div>
          <div className="grid grid-cols-3 gap-3">
      ...
      {slices.length > 0 && (
        <div className="rounded-lg border border-[var(--console-border-soft)] bg-[var(--console-card-bg)] p-3">
          <div className="mb-2 text-[10px] font-semibold uppercase text-cafe-secondary">Slice Progress</div>
...
function StatCard({ label, value, sub }: { label: string; value: string; sub: string }) {
  return (
    <div className="rounded-lg border border-[var(--console-border-soft)] bg-[var(--console-card-bg)] p-3 text-center">
      ...
      <div className="text-[10px] font-medium text-cafe-secondary">{label}</div>
