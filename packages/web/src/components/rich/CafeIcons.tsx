...
const iconPaths: Record<string, string> = {
  ...
  globe: 'M12 2a10 10 0 100 20 10 10 0 000-20zm0 0c-2.5 2.7-4 6.2-4 10s1.5 7.3 4 10m0-20c2.5 2.7 4 6.2 4 10s-1.5 7.3-4 10M2 12h20',
  scale: 'M12 4v16m-7-2h14M5 8h5m4 0h5m-14 0l-2.5 4.5A2.5 2.5 0 005 16a2.5 2.5 0 002.5-3.5L5 8zm14 0l2.5 4.5A2.5 2.5 0 0119 16a2.5 2.5 0 01-2.5-3.5L19 8z',
  trophy: 'M8 4h8v3a4 4 0 01-8 0V4zm-3 1h3v2a3 3 0 01-3 3H4a3 3 0 01-3-3V5h4zm14 0h4v2a3 3 0 01-3 3h-1a3 3 0 01-3-3V5h3zM12 11v4m-4 5h8m-7-2v2m6-2v2',
  ...
  flame: 'M12 3s4 3.5 4 7a4 4 0 11-8 0c0-2.5 1.5-4.5 4-7zm0 8c1.5 1 2.5 2.2 2.5 3.8a2.5 2.5 0 11-5 0c0-1.6 1-2.8 2.5-3.8z',
