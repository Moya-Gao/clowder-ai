  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={onExit}
        className="absolute top-3 right-3 z-20 flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-medium bg-cocreator-light/70 text-cocreator-dark/80 backdrop-blur-sm shadow-sm hover:bg-cocreator-light transition-colors"
      >
        <svg
          width="8"
          height="8"
