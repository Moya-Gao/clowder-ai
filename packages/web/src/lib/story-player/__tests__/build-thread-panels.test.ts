...
describe('buildThreadPanels', () => {
  ...
  it('assigns spotlight mode to the spotlight thread', () => {
    ...
    const t1Panel = result.find((p) => p.threadId === 't1');
    expect(t1Panel).toBeDefined();
  ...
  it('assigns active mode to non-spotlight active threads', () => {
    ...
    const t2Panel = result.find((p) => p.threadId === 't2');
    expect(t2Panel).toBeDefined();
  ...
  it('assigns dim mode to non-active threads (P1 regression)', () => {
    ...
    const t3Panel = result.find((p) => p.threadId === 't3');
    expect(t3Panel).toBeDefined();
  ...
  it('partitions visible events by sourceThreadId', () => {
    ...
    expect(t1Panel.messages).toHaveLength(2);
