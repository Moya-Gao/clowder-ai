...
function buildMatchers(dict, direction) {
  ...
  for (const term of terms) {
    ...
    //
    // 1. Target has canonical (e.g. role.co_creator: home.canonical = "铲屎官"):
 ...
 * - CJK and symbol-prefixed terms (e.g. @landy, 铲屎官) get no \b since
 ...
 *   - When "Cat Cafe Hub" and "Cat Cafe" both match at the same location,
