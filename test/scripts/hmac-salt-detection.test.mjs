...
describe('#705 bash test script runs green', () => {
  it('scripts/test-hmac-salt-detection.sh exits 0', () => {
    const result = execFileSync('bash',
      [join(ROOT, 'scripts', 'test-hmac-salt-detection.sh')],
